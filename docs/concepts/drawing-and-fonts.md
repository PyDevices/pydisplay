...
| String FB + `blit_rect` | [`font_simpletest.py`](https://github.com/PyDevices/pydevices-examples/blob/main/lib/examples/font_simpletest.py) (`string_blit` phase) | Opaque bg; low RAM; one blit per string — good desktop + tight MCU RAM |
| `Font.text(display_drv, …)` | [`font_simpletest.py`](https://github.com/PyDevices/pydevices-examples/blob/main/lib/examples/font_simpletest.py) (`per_pixel` phase) | Transparent; lowest RAM; slowest on SPI |
| `DisplayBuffer` + `show(dirty)` | [`font_simpletest.py`](https://github.com/PyDevices/pydevices-examples/blob/main/lib/examples/font_simpletest.py) (`displaybuf` phase) | Transparent; full-screen RAM; fastest repeated text on MCU |
