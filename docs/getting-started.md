...
4. **Wokwi simulator** — open the [ESP32-S3 example project](https://wokwi.com/projects/415770470006384641).
...
See the [minimum-config Wokwi project](https://wokwi.com/projects/404248867674669057) for a working example.
