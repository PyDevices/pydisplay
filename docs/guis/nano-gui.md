...
pydevices-examples does **not** vendor Nano-GUI in the git repo. [`color_setup.py`](https://github.com/PyDevices/pydevices-examples/blob/main/src/utils/color_setup.py) calls [`fetch_ph_gui`](https://github.com/PyDevices/pydevices-examples/blob/main/src/utils/fetch_ph_gui.py) to install the `gui/` tree into `utils/` and patch `pygraphics.FrameBuffer` isinstance checks. Display wiring uses [`displaybuf.py`](https://github.com/PyDevices/pydevices-examples/blob/main/src/utils/displaybuf.py).
...
| `color_setup.py` | `src/utils/` | Ships with pydevices-examples — fetches nano-gui, creates `ssd` |
...
[`src/examples/nano_gui_simpletest.py`](https://github.com/PyDevices/pydevices-examples/blob/main/src/examples/nano_gui_simpletest.py) — hardware verification from the [upstream docs](https://github.com/peterhinch/micropython-nano-gui#23-verifying-hardware-configuration).
