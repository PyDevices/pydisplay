...
**Manifest freshness** — runs when `src/`, `packages/`, `web/pyscript/`, `sim/wokwi/`, `board_configs/`, `scripts/install_*`, `scripts/gallery_generator.py`, or `scripts/audit_board_config_pairs.py` change:
