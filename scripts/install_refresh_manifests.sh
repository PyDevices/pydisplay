#!/usr/bin/env bash
# Refresh install manifests derived from lib/ (packages, micropython.toml).
#
# Usage:
...
MICROPYTHON_TOML=.site/pyscript/micropython.toml
PYODIDE_TOML=.site/pyscript/pyodide.toml
PYSCRIPT_JSON_CONFIGS=(
    .site/pyscript/micropython.json
    .site/pyscript/pyodide.json
    .site/pyscript/pydevices-examples.json
    .site/pyscript/peterhinch-nano.json
    .site/pyscript/peterhinch-micro.json
    .site/pyscript/peterhinch-touch.json
)
...
Generated by install_gen_manifests.py:
  ...
  .site/pyscript/pyodide.json
  .site/pyscript/pydevices-examples.json
  .site/pyscript/peterhinch-{nano,micro,touch}.json
  .site/pyscript/packages → ../../packages (symlink)
    ...
    for path in "${generated[@]}"; do
        case "$path" in
            ...
            "$PYODIDE_TOML")
                ...
                ;;
            .site/pyscript/micropython.json|.site/pyscript/pyodide.json|.site/pyscript/pydevices-examples.json|.site/pyscript/peterhinch-*.json)
