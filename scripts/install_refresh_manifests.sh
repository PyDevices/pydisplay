...
# pydisplay core packages (displaysys/eventsys/multimer) are micropython-lib only.
...
Generated by install_gen_manifests.py:
  packages/{add_ons,examples}.json
...
pydisplay core packages (displaysys, eventsys, multimer) are not emitted as
