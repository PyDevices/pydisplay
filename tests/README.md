...
| `test_framebuf.py` | the MP-parity `utils/framebuf` module (pixels, fill, scroll, text, blit, poly) |
| `test_framebuf_sync.py` | generated `graphics/framebuf.py` matches canonical `utils/framebuf.py` |
