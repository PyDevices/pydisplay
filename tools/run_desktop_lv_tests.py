...
Thin wrapper around ``lv_timer_test_kit.py``: pump + async only, strict click
...
For the full matrix (including no_pump and per-runtime selection), use
``python tools/lv_timer_test_kit.py`` instead.
"""
